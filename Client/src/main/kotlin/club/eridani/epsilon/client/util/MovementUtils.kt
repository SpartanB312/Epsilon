...
object MovementUtils {
    ...
    fun SafeClientEvent.calcMoveYaw(yawIn: Float = mc.player.rotationYaw, moveForward: Float = club.eridani.epsilon.client.util.MovementUtils.roundedForward, moveString: Float = club.eridani.epsilon.client.util.MovementUtils.roundedStrafing): Double {
