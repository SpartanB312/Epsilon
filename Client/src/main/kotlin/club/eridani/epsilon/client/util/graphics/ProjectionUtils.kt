...
object ProjectionUtils {
    ...
    private val modelMatrix = org.joml.Matrix4f()
    ...
    fun toScreenPosScaled(pos: Vec3d): Vec3d {
    ...
    private fun transformVec3(vec3d: Vec3d): org.joml.Vector4f {
        ...
        val vector4f = org.joml.Vector4f(relativeX, relativeY, relativeZ, 1.0f)
    ...
    private fun transformVec4(vec: org.joml.Vector4f, matrix: org.joml.Matrix4f) {
        val x = vec.x
        val y = vec.y
        val z = vec.z
    ...
    private fun isVisible(vector4f: org.joml.Vector4f, width: Float, height: Float): Boolean {
    ...
    fun updateMatrix() {
        ...
        MatrixUtils.getMatrix(projectionMatrix)
        MatrixUtils.getMatrix(modelMatrix)
