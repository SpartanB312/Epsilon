package club.eridani.epsilon.client.util.inventory
...
import club.eridani.epsilon.client.management.InventoryTaskManager
import club.eridani.epsilon.client.util.TimeUnit
import club.eridani.epsilon.client.util.delegate.ComputeFlag
...
inline fun AbstractModule.inventoryTask(block: InventoryTask.Builder.() -> Unit) =
    club.eridani.epsilon.client.util.inventory.InventoryTask.Builder()
        .apply {
            priority(priority)
        }.apply(block)
        .build()
        .also {
            club.eridani.epsilon.client.management.InventoryTaskManager.addTask(it)
        }
