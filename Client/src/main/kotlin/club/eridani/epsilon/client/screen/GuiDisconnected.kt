package club.eridani.epsilon.client.screen

import club.eridani.epsilon.client.module.combat.AutoLog
...
class GuiDisconnected(private val reason: Array<String>, private val screen: GuiScreen, private val disable: Boolean, private val logoutTime: LocalTime) : GuiScreen() {
