...
import club.eridani.epsilon.client.mixin.mixins.accessor.network.*
...
val CPacketCloseWindow.windowID: Int
    get() = (this as AccessorCPacketCloseWindow).epsilonGetWindowID()
...
var CPacketPlayerTryUseItemOnBlock.side: EnumFacing
    get() = this.direction
    set(value) {
        (this as AccessorCPacketPlayerTryUseItemOnBlock).epsilonSetSide(value)
    }
...
val SPacketEntityStatus.entityID: Int
    get() = (this as AccessorSPacketEntityStatus).epsilonGetEntityID()
