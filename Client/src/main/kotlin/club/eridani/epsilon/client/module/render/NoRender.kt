...
internal object NoRender : Module(
    ...
    // Entities
    private val player0 by setting("Player", Mode.OFF, page.atValue(Page.ENTITY))
    ...
    private val range by setting("Range", 16, 0..128, 2, page.atValue(Page.TILE_ENTITY) and NoRender::tileEntityRange)
