...
import club.eridani.epsilon.client.common.collections.EnumSet
...
fun SafeClientEvent.placeBlock(
    ...
    val sneak = !player.isSneaking && club.eridani.epsilon.client.util.items.blockBlacklist.contains(world.getBlock(placeInfo.pos))
