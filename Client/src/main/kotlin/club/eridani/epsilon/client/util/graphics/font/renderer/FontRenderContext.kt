...
abstract class AbstractFontRenderContext {
    ...
    abstract fun checkFormatCode(text: String, index: Int, rendering: Boolean): Boolean
...
class FontRenderContext(override val fontRenderer: FontRenderer) : AbstractFontRenderContext() {
    ...
    override fun checkFormatCode(text: String, index: Int, rendering: Boolean): Boolean {
