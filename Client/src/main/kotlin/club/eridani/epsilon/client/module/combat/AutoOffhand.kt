...
import club.eridani.epsilon.client.util.extension.isWeapon
...
import club.eridani.epsilon.client.util.inventory.confirmedOrTrue
import club.eridani.epsilon.client.util.inventory.inventoryTaskNow
import club.eridani.epsilon.client.util.inventory.operation.moveTo
import club.eridani.epsilon.client.util.inventory.operation.swapToItemOrMove
import club.eridani.epsilon.client.util.inventory.slot.craftingSlots
import club.eridani.epsilon.client.util.inventory.slot.hotbarSlots
import club.eridani.epsilon.client.util.inventory.slot.inventorySlots
import club.eridani.epsilon.client.util.inventory.slot.offhandSlot
import club.eridani.epsilon.client.util.isFakeOrSelf
import club.eridani.epsilon.client.util.threads.defaultScope
import club.eridani.epsilon.client.common.extensions.potion
import club.eridani.epsilon.client.util.combat.CombatUtils.calcDamageFromMob
import club.eridani.epsilon.client.util.combat.CombatUtils.calcDamageFromPlayer
