...
object MetroTheme : IDefaultBothTheme, SpartanScreen() {
    ...
    override fun bindButton(bindButton: BindButton, mouseX: Int, mouseY: Int, partialTicks: Float) {
        with(bindButton) {
            ...
            val color = if (GuiSetting.dynamicRainbow.value && GuiSetting.rainbow.value)
                club.eridani.epsilon.client.util.ColorUtils.rainbowRGB(y * -5, GuiSetting.saturation.value, GuiSetting.brightness.value)
            else
                club.eridani.epsilon.client.management.GUIManager.firstColor
    ...
    override fun booleanButton(booleanButton: BooleanButton, mouseX: Int, mouseY: Int, partialTicks: Float) {
        with(booleanButton) {
            ...
            val y = this.y
            draw {
                club.eridani.epsilon.client.util.graphics.RenderUtils2D.drawRoundedRectangle(
                    x.toDouble() + 3,
                    y.toDouble() + height / 2.0 - 3,
                    15.0,
                    6.8,
                    3.0,
                    club.eridani.epsilon.client.util.ColorUtils.hsbToRGB(hsbColor.h, hsbColor.s, hsbColor.b - 0.3f)
                )
                club.eridani.epsilon.client.util.graphics.RenderUtils2D.drawFilledCircle(
                    x.toDouble() + 6.3 + booleanButton.currentValue,
                    y + height / 2.0 + 0.4,
                    4.4,
                    club.eridani.epsilon.client.util.ColorUtils.hsbToRGB(hsbColor.h, hsbColor.s, hsbColor.b - 0.1f)
                )
            }
        }
    }
    ...
    override fun colorPicker(colorPicker: ColorPicker, mouseX: Int, mouseY: Int, partialTicks: Float) {
        with(colorPicker) {
            ...
            if (this.sliding) {
                setting.value =
                    club.eridani.epsilon.client.util.ColorUtils.hsbToRGB(
            ...
            currentValue = club.eridani.epsilon.client.util.graphics.AnimationUtil.animate(currentHsb.h, currentValue, 0.1f)
            ...
            if (isHoovered(mouseX, mouseY)) {
                ...
                draw {
                    RenderUtils2D.glScissor(
                        ...
                        cachedX + width,
                        cachedY + height,
                        club.eridani.epsilon.client.util.ScaleHelper.scaledResolution
                    )
