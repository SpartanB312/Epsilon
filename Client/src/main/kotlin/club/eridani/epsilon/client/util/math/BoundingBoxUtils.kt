...
import club.eridani.epsilon.client.util.math.VectorUtils.plus
import club.eridani.epsilon.client.util.math.VectorUtils.times
...
fun AxisAlignedBB.isInSight(
    ...
    rotation: Vec2f = Wrapper.player?.let { Vec2f(it.posX, it.posY) } ?: Vec2f.ZERO,
    range: Double = 4.25,
