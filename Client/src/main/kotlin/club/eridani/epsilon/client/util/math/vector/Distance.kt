...
package club.eridani.epsilon.client.util.math.vector
...
inline fun Entity.distanceSqTo(entity: Entity): Double {
    return distanceSq(this.posX, this.posY, this.posZ, entity.posX, entity.posY, entity.posZ)
}
